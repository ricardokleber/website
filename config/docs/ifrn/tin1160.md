...
??? note "Programa da Disciplina"
    ...
    **Ementa**
    ...
    Introdução às redes de computadores. Estudo dos padrões e modelos de redes. Noções de redes locais cabeadas e sem fio. Noções de dispositivos de redes e Pilha de protocolos TCP/IP. Discussão sobre segurança de redes.
    ...
    **Bases Científico-Tecnológicas (Conteúdos)**
    ...
    3. Camada de acesso à rede.
        3. Visão geral da família Ethernet (IEEE 802.3).
        4. Introdução às redes sem fio (IEEE 802.11).
    ...
    **Recursos Didáticos**
    ...
    Utilização de quadro branco, computador com acesso à internet, projetor multimídia, equipamentos e ferramentas para práticas em laboratório.
