![Fundamentos de Sistemas Operacionais e Sistemas Operacionais de Redes](./assets/images/banner_tin0022.jpg)
...
??? note "[Roteiro] Lista de Exercícios de Fixação 01"
    ...
    read NOME
    echo "Bem-vindo(a), $NOME! É um prazer ter você aqui."
    ```
...
### 6. Introdução à administração do sistema operacional
??? abstract "Slides - Parte 01"
    <div class="video-wrapper">
        <iframe src="https://docs.google.com/presentation/d/e/2PACX-1vSCT25VdLC_IM_ZHyMkXknA8Ser_uDs7W1yYojOld8qQNwIqd1WEbgNQViFkkJwWPkG02VcXMmldxb3/pubembed?start=false&loop=false&delayms=3000" frameborder="0" width="1058" height="440" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe>
    </div>
...
??? note "[Exercícios] Administração Linux - Parte 01"

    ## **Exercícios de Fixação: Administração de Sistemas Linux - Parte 01**

    ### 1\. Crie os usuários: superman, batman, gato, cachorro, azul e verde.

    * Visualize os usuários criados em /etc/passwd identificando o UID, GID e Shell atribuídos a cada um deles.  
    * Visualize as senhas de cada usuário criado armazenadas no arquivo /etc/shadow  (em formato criptografado).  
    * Visualize os grupos criados em /etc/group identificando os grupos criados/atribuídos a cada usuário criado.

    ### 2\. Crie os grupos: herois, animais e cores e insira os usuários criados no exercício anterior em seus respectivos grupos.

    * Visualize os usuários inseridos em cada grupo no arquivo /etc/group.

    ### 3\. Mude o usuário que você está acessando o sistema para superman. Crie o arquivo ‘teste01’ com um conteúdo qualquer.  

    ### 4\. Troque o grupo do arquivo ‘teste01’ para ‘herois’.  
    
    ### 5\. Dê permissão ao grupo herois para ler (read) o arquivo ‘teste01’.  
    
    ### 6\. Acesse o sistema com o usuário ‘batman’ e leia o conteúdo de ‘teste01’ na área do usuário ‘superman’. Você conseguiu?  
    
    ### 7\. Acesse o sistema com o usuário ‘cachorro’ e leia o conteúdo de ‘teste01’ na área do usuário ‘superman’. Você conseguiu?  
    
    ### 8\. Acesse o sistema com o usuário superman e dê permissão total ao grupo herois para manipular o arquivo ‘teste01’.  
    
    ### 9\. Acesse o sistema com o usuário ‘batman’ e leia o conteúdo de ‘teste01’ na área do usuário ‘superman’. Você conseguiu?  
    
    ### 10\. Acesse o sistema com o usuário ‘cachorro’ e leia o conteúdo de ‘teste01’ na área do usuário ‘superman’. Você conseguiu?

#### - 6.4. Tratamento de processos
#### - 6.5. Configurações de rede
??? abstract "Slides - Parte 02"
    <div class="video-wrapper">
        <iframe src="https://docs.google.com/presentation/d/e/2PACX-1vSJYrXIG85a8kl87Wo2NxQMmrhVNmEymRz2CedbuP_tRJgbmWt2l0dsf-3joB3lxd7Gz8Hpwxj2u4H-/pubembed?start=false&loop=false&delayms=3000" frameborder="0" width="1058" height="440" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe>
    </div>
---
## 3. Bimestre
### 7. Visão geral da família Windows
